"""
Django settings for helloapp_39909 project.
...
ROOT_URLCONF = 'helloapp_39909.urls'
...
WSGI_APPLICATION = 'helloapp_39909.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "helloapp_39909 API",
    "DESCRIPTION": "API documentation for helloapp_39909 App",
    "VERSION": "v1",
}
